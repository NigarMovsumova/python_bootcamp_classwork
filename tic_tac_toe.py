...
# buttonlari istifadeden kenarlasdirmaq zad
...
def checkifwin():
    ...
    ##########indi eynisini Olarin udmagi ucun
    ...
    if count == 9 and winner == False:
        messagebox.showinfo("Tic Tac toe", "It is a tie!" "No one wins!")
...
def b_clicked(b):
    ...
    if b["text"] == " " and clicked == True:
        ...
        messagebox.showerror("Tic Tac Toe", "This box has been selected. Select other box!")


# buttonlari yaratmaq zad
def reset():
