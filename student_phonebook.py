...
# phone_number_list = []
#
# for key, value in phone_number:
#     phone_number_list.append(key and value)
...
def add_contact():
    phone_number_list.append(
        [name.get(), surname.get(), first_number.get(), second_number.get(), email.get(), address.get()])
    select_set()


def edit():
    phone_number_list[selected()] = [name.get(), surname.get(), first_number.get(), second_number.get(), email.get(),
                                     address.get()]
    select_set()


def delete():
    del phone_number_list[selected()]
    select_set()


def view():
    NAME, SURNAME, FIRST_NUMBER, SECOND_NUMBER, EMAIL, ADDRESS = phone_number_list[selected()]
    name.set(NAME)
    surname.set(SURNAME)
...
def select_set():
    ...
    for name, surname, first_number, second_number, email, address in phone_number:
